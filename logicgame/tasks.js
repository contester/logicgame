...
{
	id: 4,
	text: '<p>Али-Баба наткнулся в пещере разбойников на два сундука. Он знает, что в каждом из них либо могут быть сокровища,'+
	...
	]},
{
	...
	' один из которых рыцарь, а второй – лжец. Полиция арестовала всех троих. В ходе допроса были получены следующие высказывания:</p>' +
	...
	help:[
		...
		"Что ответит шпион на вопрос «Кто ты?», если он говорит правду? Что шпион ответит на этот же вопрос, если он лжет?",
	...
	help: []},
{
	...
	answer: 1,
	help: [
		"Могут ли все 4 жителя быть лжецами?",
	...
	]},
{
	...
	answer: 1,
	help: [
		"Возможна ли ситуация – два утверждения ложны?",
	...
	]},
{
	...
	answer: 3,
	help: [
		"Возможна ли ситуация – все утверждения истинны?",
		"Пусть надпись на первом камне ложна, тогда..."
	]},
{
	id: 16,
	text: '<p>На острове рыцарей и лжецов перед судом предстали три островитянина Аб, Боб и Вит. Один из них совершил преступление.</p>' +
	...
	]},
{
	...
	'<p>На втором пузырьке: «Зелье не в этом пузырьке».</p><p>На третьем пузырьке: «Зелье не в первом пузырьке».</p>' +
...
{
	id: 2,
	text: '<p>Имеются три шкатулки.</p><p>На первой написано: «В этой шкатулке яд».</p><p>На второй: «В этой шкатулке послание».</p>' +
	'<p>На третьей: «Яд в темной шкатулке».</p><p>Известно, что: </p><p>1)	из этих утверждений в лучшем случае только одно истинно;</p>' +
	...
	]},
{
	...
	'<p>После этого первый заявил, что третий лжет, а второй заявил, что первый солгал оба раза. Помогите путешественнику узнать, кто из этих жителей кем является.</p>',
	answer: [2, 3, 3],
	help: [
